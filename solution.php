<?php include('header.php') ?>
		...
		<div class="nav-link">
			<ul class="breadcrumb">
				...
				<li ><a href="solution.php">Service</a></li>							
			</ul>
		</div>
		  <!-- Start about  -->
		<section id="about">
			<div class="col-md-12 col-sm-12">
				<div class="title-area text-center wow zoomIn">
						...
						<div class="col-md-6">
							<div class="our-skill">
								...
								<div class="our-skill-content">
									...
									<div class="progress">
										<div class="progress-bar six-sec-ease-in-out" role="progressbar" data-transitiongoal="95">
									...
									<div class="panel panel-default">
										...
										<div id="collapseOne" class="panel-collapse collapse in">
											<div class="panel-body">
												<img class="why-choose-img" src="img/team1.jpg" alt="img">
				...
				<div class="service-content">
					<div class="row">
						...
						<div class="col-md-6 col-sm-6">
							<a href="webdev.php?page=webdev.php">
						...
						<!-- Start single service -->
						<div class="col-md-6 col-sm-6">
							<a href="sfdev.php?pgae=sfdev.php">
								<div class="single-service wow zoomIn">
						...
						<div class="col-md-6 col-sm-6">
							<a href="host.php?page=host.php">
								<div class="single-service wow zoomIn">
									<i class="fa fa-mobile service-icon"></i>
									<h4 class="service-title">Hosting</h4>
									<p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form.</p>
								</div>
							</a>
						</div>
